...
- Have you followed everything in the [docs](/docs)?
- Is your Python virtual environment active?
- Did you download the latest version of _{APP_DESCRIPTION}_?
...
- Are you using the latest version of _{APP_DESCRIPTION}_? If not, run the
  [installing guide](/docs/install) again.
...
- Is this an issue with _{APP_DESCRIPTION}_ itself, or an installation error,
  ...
  touch](/docs/additional-resources/get-in-touch).
