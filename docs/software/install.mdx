...
10. Close the shell
11. You can now [run a campaign](https://github.com/sound-scape-explorer/sound-scape-explorer/wiki/running-campaigns)
...
- [ ] TODO: Add small video illustrating the drag and drop
...
14. You can now [run a campaign](https://github.com/sound-scape-explorer/sound-scape-explorer/wiki/running-campaigns)
