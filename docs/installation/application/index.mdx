...
import {AppIcon, MacOsIcon, PythonIcon, UbuntuIcon, WindowsIcon,} from '@site/src/components/Icons';
...
<ol>
  ...
  :::tip
  Instead of manual entry, drag and drop the folder icon into your
  terminal.
  :::
