...
- **VGGish** - General audio embeddings
- **PERCH** - Perceptual audio hashing
- **SurfPERCH** - Surface-level perceptual features
- **YAMNet** - Audio event detection
- **BirdNET** - Specialized for avian bioacoustics
- **Music Classifier** - Musical content analysis
